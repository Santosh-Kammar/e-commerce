  ...
  return (
    <div className="hero-section-wrapper relative">
      <section className="bg-teal-600 text-white text-center py-20 sm:py-24 mt-8 relative">
        ...
        <div className="absolute top-1/2 left-0 transform -translate-y-1/2 pl-4 hidden sm:block">
          <img
        ...
        <div className="absolute top-1/2 right-0 transform -translate-y-1/2 pr-4 hidden sm:block">
          <img
